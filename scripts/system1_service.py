...
from gr00t.model.system1_policy import Gr00tPolicy
...
def main(args: ArgsConfig):
    if args.server:
        ...
        # Start the server
        if args.http_server:
            from gr00t.eval.system1_server import HTTPInferenceServer  # noqa: F401
    ...
    # Here is mainly a testing code
        ...
        if args.http_server:
            ...
            print(f"Http Response Time: {(end - start)*1000}")
        else:
